...
import { bigIntToBuffer, setLengthLeft, setLengthRight } from '@nomicfoundation/util'
...
/**
 * Proxy function for @nomicfoundation/util's setLengthLeft, except it returns a zero
